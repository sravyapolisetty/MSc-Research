...
opt = {
	binfilename = '/home/spoliset/TraceNN-Exp/data/wordembedding/glove.840B.300d.txt',
	outVecs = tracenn.data_dir .. '/wordembedding/glove.840B.300d.vecs',
  outVocab = tracenn.data_dir .. '/wordembedding/glove.840B.300d.vocab'
}

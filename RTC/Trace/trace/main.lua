...
Training script for semantic relatedness prediction on the TRACE dataset.
  ...
  -o,--output_dir (default '/work_dir/TraceNN-Exp/tracenn_docker/') Output directory
  -w,--wordembedding_name (default 'word2vec.300d') Name of the word embedding file
...
print('mapping artifacts to words embeddings')

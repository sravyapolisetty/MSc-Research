...
#lib_path = str(os.path.join(os.path.dirname(os.path.realpath(__file__)), 
#                        'word2vec_ops.so'))

lib_path = '/Users/sravyapolisetty/Desktop/PythonScripts/word2vec_ops.so'
word2vec = tf.load_op_library(lib_path)

flags = tf.app.flags

flags.DEFINE_string("save_path","/Users/sravyapolisetty/Desktop", None)
flags.DEFINE_string("train_data", "/Users/sravyapolisetty/Desktop/IBM_Corpus.txt",None)
flags.DEFINE_string("eval_data", "/Users/sravyapolisetty/questions-words.txt",None)
